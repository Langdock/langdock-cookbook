...
| **Apps & UI** | [`apps/servicenow/`](apps/servicenow/) | Interactive in-chat ServiceNow records — suggest related knowledge articles while creating tickets, discover task tickets with user-friendly filters, and edit ticket fields, state, and activity — with OAuth + Dynamic Client Registration. |
